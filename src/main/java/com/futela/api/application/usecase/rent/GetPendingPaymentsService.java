...
import com.futela.api.domain.port.in.rent.GetPendingPaymentsUseCase;
...
public class GetPendingPaymentsService implements GetPendingPaymentsUseCase {
    private final RentInvoiceRepositoryPort invoiceRepository;
    private final LeaseRepositoryPort leaseRepository;

    public GetPendingPaymentsService(RentInvoiceRepositoryPort invoiceRepository, LeaseRepositoryPort leaseRepository) {
